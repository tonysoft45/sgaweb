// ----------------------------------------------------------------------------------
// cat_motivotraspaso.sql.class_2.0.0.cs
// ----------------------------------------------------------------------------------
...
namespace Cat_MotivoTraspaso
{

class cltbl_Cat_MotivoTraspaso_v2_0_0
{
	 ...
	 // Base de datos
	 private  String NombreDeLaTabla = "tbl_cat_motivostraspaso";
     private  String NombreDeLaVista = "tbl_cat_motivostraspaso";
     private  String NombreCampoLlave ="nIDCat_MotivosTraspaso";
	 private  String NombreCampoOrdenamiento="Motivo";
	 private  String NombreCampoParaNoRepetir="IDMotivoTraspaso";
