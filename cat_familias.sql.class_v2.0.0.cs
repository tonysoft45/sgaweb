// ----------------------------------------------------------------------------------
// cat_familias.sql.class_2.0.0.cs
// ----------------------------------------------------------------------------------
...
namespace Cat_Familias
{

class cltbl_Cat_Familias_v2_0_0
{
	 ...
	 // Base de datos
	 private  String NombreDeLaTabla = "tbl_cat_familias";
     private  String NombreDeLaVista = "tbl_cat_familias";
     private  String NombreCampoLlave ="nIDCat_Familia";
	 private  String NombreCampoOrdenamiento="Familia";
	 private  String NombreCampoParaNoRepetir="IDFamilia";
