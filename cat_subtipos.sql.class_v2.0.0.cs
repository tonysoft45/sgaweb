// ----------------------------------------------------------------------------------
// cat_subtipos.sql.class_2.0.0.cs
// ----------------------------------------------------------------------------------
...
namespace Cat_Subtipos
{

class cltbl_Cat_Subtipos_v2_0_0
{
	 ...
	 // Base de datos
	 private  String NombreDeLaTabla = "tbl_cat_subtipos";
     private  String NombreDeLaVista = "tbl_cat_subtipos";
     private  String NombreCampoLlave ="nIDCat_SubTipo";
	 private  String NombreCampoOrdenamiento="SubTipo";
	 private  String NombreCampoParaNoRepetir="IDSubTipo";
