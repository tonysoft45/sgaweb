// ----------------------------------------------------------------------------------
// cat_proveedores.sql.class_2.0.0.cs
// ----------------------------------------------------------------------------------
...
namespace Cat_Proveedores
{

class cltbl_Cat_Proveedores_v2_0_0
{
	 ...
	 // Base de datos
	 private  String NombreDeLaTabla = "tbl_cat_proveedores";
     private  String NombreDeLaVista = "tbl_cat_proveedores";
     private  String NombreCampoLlave ="nIDCat_Proveedor;
	 private  String NombreCampoOrdenamiento="RazonSocial";
	 private  String NombreCampoParaNoRepetir="IDProveedor";
