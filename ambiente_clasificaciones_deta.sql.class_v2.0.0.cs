// ----------------------------------------------------------------------------------
// ambiente_clasificaciones_deta.sql.class_2.0.0.cs
// ----------------------------------------------------------------------------------
...
namespace Ambiente_clasificaciones_deta
{

class cltbl_Ambiente_Clasificaciones_deta_v2_0_0
{
	 ...
	 // Base de datos
	 private  String NombreDeLaTabla = "tbl_ambiente_clasificaciones_deta";
     private  String NombreDeLaVista = "tbl_ambiente_clasificaciones_deta_view";
     private  String NombreCampoLlave ="nIDAmbiente_Clasificacion_Deta";
	 private  String NombreCampoOrdenamiento="nIDAmbiente_Clasificacion";
	 private  String NombreCampoParaNoRepetir="nIDModulo";
