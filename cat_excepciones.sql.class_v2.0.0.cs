// ----------------------------------------------------------------------------------
// cat_excepciones.sql.class_2.0.0.cs
// ----------------------------------------------------------------------------------
...
namespace Cat_Excepciones
{

class cltbl_Cat_Excepciones_v2_0_0
{
	 ...
	 // Base de datos
	 private  String NombreDeLaTabla = "tbl_cat_excepciones";
     private  String NombreDeLaVista = "tbl_cat_excepciones";
     private  String NombreCampoLlave ="nIDCat_Excepcion";
	 private  String NombreCampoOrdenamiento="Excepcion";
	 private  String NombreCampoParaNoRepetir="IDExcepcion";
