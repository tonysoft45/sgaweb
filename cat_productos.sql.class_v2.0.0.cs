// ----------------------------------------------------------------------------------
// cat_productos.sql.class_2.0.0.cs
// ----------------------------------------------------------------------------------
...
namespace Cat_Productos
{

class cltbl_Cat_Productos_v2_0_0
{
	 ...
	 // Base de datos
	 private  String NombreDeLaTabla = "tbl_cat_productos";
     private  String NombreDeLaVista = "tbl_cat_productos_view";
     private  String NombreCampoLlave ="IDProducto";
	 private  String NombreCampoOrdenamiento="Producto";
	 private  String NombreCampoParaNoRepetir="Codigo";
