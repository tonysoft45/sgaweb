// ----------------------------------------------------------------------------------
// ambiente_datosdelaempresa.sql.class_2.0.0.cs
// ----------------------------------------------------------------------------------
...
namespace Ambiente_DatosDeLaEmpresa
{

class cltbl_Ambiente_DatosDeLaEmpresa_v2_0_0
{
	 ...
	 // Base de datos
	 private  String NombreDeLaTabla = "tbl_ambiente_datosdelaempresa";
     private  String NombreDeLaVista = "tbl_ambiente_datosdelaempresa_view";
     private  String NombreCampoLlave ="nIDDatosDeLaEmpresa";
	 private  String NombreCampoOrdenamiento="nIDDatosDeLaEmpresa";
	 private  String NombreCampoParaNoRepetir="RazonSocial";
