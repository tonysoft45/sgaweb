// ----------------------------------------------------------------------------------
// cat_estados.sql.class_2.0.0.cs
// ----------------------------------------------------------------------------------
...
namespace Cat_Estados
{

class cltbl_Cat_Estados_v2_0_0
{
	 ...
	 // Base de datos
	 private  String NombreDeLaTabla = "tbl_cat_estados";
     private  String NombreDeLaVista = "tbl_cat_estados";
     private  String NombreCampoLlave ="nIDCat_Estado";
	 private  String NombreCampoOrdenamiento="Estado";
	 private  String NombreCampoParaNoRepetir="IDEstado";
