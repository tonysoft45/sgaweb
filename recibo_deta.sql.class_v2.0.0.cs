// ----------------------------------------------------------------------------------
// recibo_deta.sql.class_2.0.0.cs
// ----------------------------------------------------------------------------------
...
namespace Recibo_Deta
{

class cltbl_Recibo_Deta_v2_0_0
{
	 ...
	 // Base de datos
	 private  String NombreDeLaTabla = "tbl_recibo_deta";
     private  String NombreDeLaVista = "tbl_recibo_deta";
     private  String NombreCampoLlave ="nIDRecibo_Deta";
	 private  String NombreCampoOrdenamiento="nIDRecibo_Deta";
