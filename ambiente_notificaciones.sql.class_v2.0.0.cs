// ----------------------------------------------------------------------------------
// ambiente_notificaciones.sql.class_2.0.0.cs
// ----------------------------------------------------------------------------------
...
namespace Ambiente_Notificaciones
{

class cltbl_Ambiente_Notificaciones_v2_0_0
{
	 ...
	 // Base de datos
	 private  String NombreDeLaTabla = "tbl_ambiente_notificaciones";
     private  String NombreDeLaVista = "tbl_ambiente_notificaciones";
     private  String NombreCampoLlave ="nIDNotificacion";
	 private  String NombreCampoOrdenamiento="nIDNotificacion";
