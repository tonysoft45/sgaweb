// ----------------------------------------------------------------------------------
// cat_empresas.sql.class_2.0.0.cs
// ----------------------------------------------------------------------------------
...
namespace Cat_Empresas
{

class cltbl_Cat_Empresas_v2_0_0
{
	 ...
	 // Base de datos
	 private  String NombreDeLaTabla = "tbl_cat_empresa";
     private  String NombreDeLaVista = "tbl_cat_empresa";
     private  String NombreCampoLlave ="nIDCat_Empresa";
	 private  String NombreCampoOrdenamiento="RazonSocial";
	 private  String NombreCampoParaNoRepetir="ID";
