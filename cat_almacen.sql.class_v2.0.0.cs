// ----------------------------------------------------------------------------------
// cat_almacen.sql.class_2.0.0.cs
// ----------------------------------------------------------------------------------
...
namespace Cat_Almacen
{

class cltbl_Cat_Almacen_v2_0_0
{
	 ...
	 // Base de datos
	 private  String NombreDeLaTabla = "tbl_cat_almacen";
     private  String NombreDeLaVista = "tbl_cat_almacen_view";
     private  String NombreCampoLlave ="nIDCat_Almacen";
	 private  String NombreCampoOrdenamiento="Almacen";
	 private  String NombreCampoParaNoRepetir="IDAlmacen";
