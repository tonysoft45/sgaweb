// ----------------------------------------------------------------------------------
// entradaporotrosconceptos_deta.sql.class_2.0.0.cs
// ----------------------------------------------------------------------------------
...
namespace EntradaPorOtrosConceptos_Deta
{

class cltbl_EntradaPorOtrosConceptos_Deta_v2_0_0
{
	 ...
	 // Base de datos
	 private  String NombreDeLaTabla = "tbl_entradaporotrosconceptos_deta";
     private  String NombreDeLaVista = "tbl_entradaporotrosconceptos_deta_view";
     private  String NombreCampoLlave ="nIDEntradaPorOtrosConceptos_Deta";
	 private  String NombreCampoOrdenamiento="";
	 private  String NombreCampoParaNoRepetir="";
	 private  String TipoDatoCampoParaNoRepetir=""; //CADENA,FECHA,NUMERO
