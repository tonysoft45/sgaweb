// ----------------------------------------------------------------------------------
// cat_conceptossalida.sql.class_2.0.0.cs
// ----------------------------------------------------------------------------------
...
namespace Cat_ConceptosSalida
{

class cltbl_Cat_ConceptosSalida_v2_0_0
{
	 ...
	 // Base de datos
	 private  String NombreDeLaTabla = "tbl_cat_conceptossalida";
     private  String NombreDeLaVista = "tbl_cat_conceptossalida";
     private  String NombreCampoLlave ="nIDCat_ConceptoSalida";
	 private  String NombreCampoOrdenamiento="ConceptoSalida";
	 private  String NombreCampoParaNoRepetir="IDConceptoSalida";
