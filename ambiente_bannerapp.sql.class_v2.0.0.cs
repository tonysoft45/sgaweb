// ----------------------------------------------------------------------------------
// ambiente_bannerapp.sql.class_2.0.0.cs
// ----------------------------------------------------------------------------------
...
namespace Ambiente_BannerApp
{

class cltbl_Ambiente_BannerApp_v2_0_0
{
	 ...
	 // Base de datos
	 private  String NombreDeLaTabla = "tbl_ambiente_bannerapp";
     private  String NombreDeLaVista = "tbl_ambiente_bannerapp_view";
     private  String NombreCampoLlave ="nIDBannerApp";
	 private  String NombreCampoOrdenamiento="nIDBannerApp";
	 private  String NombreCampoParaNoRepetir="Imagen";
