// ----------------------------------------------------------------------------------
// cat_clientes.sql.class_2.0.0.cs
// ----------------------------------------------------------------------------------
...
namespace Cat_Clientes
{

class cltbl_Cat_Clientes_v2_0_0
{
	 ...
	 // Base de datos
	 private  String NombreDeLaTabla = "tbl_cat_clientes";
     private  String NombreDeLaVista = "tbl_cat_clientes_view";
     private  String NombreCampoLlave ="nIDCat_Cliente";
	 private  String NombreCampoOrdenamiento="RazonSocial";
	 private  String NombreCampoParaNoRepetir="IDCliente";
