// ----------------------------------------------------------------------------------
// intefaces.sql.class_v2.0.0.cs
// ----------------------------------------------------------------------------------
// Autor. Ing. Antonio Barajas del Castillo
// ----------------------------------------------------------------------------------
// Empresa. Softernium SA de CV
// ----------------------------------------------------------------------------------
// Descripcion. Almacena los datos del log de accesos 
// ----------------------------------------------------------------------------------
...
class cltbl_Interfaces_v2_0_0
{
	 ...
	 // Base de datos
	 private  String NombreDeLaTabla = "tbl_interfaces";
     private  String NombreDeLaVista = "tbl_interfaces_view";
     private  String NombreCampoLlave ="nIDInterfaz";
	 private  String NombreCampoOrdenamiento="Interfaz";
	 private  String NombreCampoParaNoRepetir="Interfaz";
	 private  String TipoDatoCampoParaNoRepetir="CADENA"; //CADENA,FECHA,NUMERO
	 ...
	 public void Cargar_Campos_Obligatorios(){	 
		...
		this.campos_obligatorios.add("Interfaz");		 	
		this.campos_obligatorios.add("nIDModulo");		 
		this.campos_obligatorios.add("Funcion");	
		this.campos_obligatorios.add("Tipo");		 		 
		...
		this.campos_obligatorios_rango2.add(999999);  		
		this.campos_obligatorios_rango2.add("");  
		this.campos_obligatorios_rango2.add("");  
		...
		this.campos_obligatorios_leyendas.add("Nombre de la Interfaz");
		this.campos_obligatorios_leyendas.add("Modulo relacionado");	
		this.campos_obligatorios_leyendas.add("Funcion a realizar");	
		this.campos_obligatorios_leyendas.add("Tipo");	
		...
		this.campos_obligatorios_valorescomparar1.add("ENVIO");  // SI,NO
		this.campos_obligatorios_valorescomparar1.add("RECEPCION");  // SI,NO
		this.campos_obligatorios_valorescomparar1.add("EJECUCION");  // SI,NO
		this.campos_obligatorios_valorescomparar1.add("ENVIO/RECEPCION");  // SI,NO
		...
		this.posicion_compararI=null;
		this.posicion_compararI=new ArrayList();			 
		// La posicion en el array indica el campo al que se hace referencia.  De acuerdo a los campos obligatorios.
		// El valor almacenado indica cuales el arreglo de donde se usaran los campos a comparar
		this.posicion_compararI.add(0); // Ej. Posicion 0: "Interfaz", si se carga un valor 0, indica que no tiene lista.
		this.posicion_compararI.add(0); // Ej. Posicion 1: "nIDModulo", si se carga un valor 0, indica que no tiene lista.
		this.posicion_compararI.add(1); // Ej. Posicion 2: "Funcion", si se carga un valor 0, indica que no tiene lista.
		this.posicion_compararI.add(2); // Ej. Posicion 3: "Tipo", si se carga un valor 0, indica que no tiene lista.
	 
		// Listas para comparar
		// Ejemplo campo:Funcion
		this.valores_compararI_1=null;
		this.valores_compararI_1=new ArrayList();
		this.valores_compararI_1.add("ENVIO");		 
		this.valores_compararI_1.add("RECEPCION");		 
		this.valores_compararI_1.add("EJECUCION");		 
		this.valores_compararI_1.add("ENVIO/RECEPCION");	
		this.valores_compararI_1.add("TODOS");		 
 
		// Ejemplo campo: Tipo
		this.valores_compararI_2=null;
		this.valores_compararI_2=new ArrayList();	
		this.valores_compararI_2.add("WEB");		 
		this.valores_compararI_2.add("APP");		 
		this.valores_compararI_2.add("CLIENTE/SERVIDOR");		  
	 }
	 ...
	 public void Cargar_Campos_Listado(){	 
		...
		this.campos_listado.add("Interfaz");
		this.campos_listado.add("Metodo");
		this.campos_listado.add("NombreDelModulo");	
		this.campos_listado.add("Funcion");			 
		this.campos_listado.add("Tipo");
		this.campos_listado.add(this.NombreCampoLlave);	 
	 }

	 public void Cargar_Campos_Busqueda(){	 
		 this .campos_busqueda=null;
		 this .campos_busqueda= ArrayList();
 
		this .campos_busqueda.add("Interfaz");
		this .campos_busqueda.add("Descripcion");	
		  this .campos_busqueda.add("API");	
		  this .campos_busqueda.add("Ubicacion");	
		  this .campos_busqueda.add("URL");	
		  this .campos_busqueda.add("Metodo");	
		  this .campos_busqueda.add("NombreDeLModulo");		
		  this .campos_busqueda.add("Funcion");			 	 

		 this .campos_busqueda_tipo=null;
		 this .campos_busqueda_tipo= ArrayList();
	 ...
	 public void Cargar_Campos_Especiales(){	 
		 ...
		 this .campos_especiales= ArrayList();
		  ...
		  this .campos_especiales.add("PasarDatos");
	 ...
	 public void Cargar_Campos_Combo(){	 
		 ...
		 this .campos_combo= ArrayList();
		  ...
		  this .campos_combo.add("Interfaz");		 	 
	 }
	 // --------------------------------------------------------
