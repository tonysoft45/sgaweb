...
class cltbl_Entradas_v2_0_0
{
	 ...
	 // Base de datos
	 private  String NombreDeLaTabla = "tbl_entradas";
     private  String NombreDeLaVista = "tbl_entradas_view";
     private  String NombreCampoLlave ="nIDEntrada";
