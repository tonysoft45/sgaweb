// ----------------------------------------------------------------------------------
// ambiente_modulos.sql.class_2.0.0.cs
// ----------------------------------------------------------------------------------
...
namespace Ambiente_Modulos
{

class cltbl_Ambiente_Modulos_v2_0_0
{
	 ...
	 // Base de datos
	 private  String NombreDeLaTabla = "tbl_ambiente_modulos";
     private  String NombreDeLaVista = "tbl_ambiente_modulos_view";
     private  String NombreCampoLlave ="nIDModulo";
	 private  String NombreCampoOrdenamiento="Nivel,Orden";
	 private  String NombreCampoParaNoRepetir="NombreDelModulo";
