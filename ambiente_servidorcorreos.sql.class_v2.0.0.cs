// ----------------------------------------------------------------------------------
// ambiente_servidorcorreos.sql.class_2.0.0.cs
// ----------------------------------------------------------------------------------
...
namespace Ambiente_Servidorcorreos
{

class cltbl_Ambiente_Servidorcorreos_v2_0_0
{
	 ...
	 // Base de datos
	 private  String NombreDeLaTabla = "tbl_ambiente_servidorcorreos";
     private  String NombreDeLaVista = "tbl_ambiente_servidorcorreos_view";
     private  String NombreCampoLlave ="nIDCorreo";
	 private  String NombreCampoOrdenamiento="nIDCorreo";
	 private  String NombreCampoParaNoRepetir="Correo";
