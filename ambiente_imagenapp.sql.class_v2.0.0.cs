// ----------------------------------------------------------------------------------
// ambiente_imagenapp.sql.class_2.0.0.cs
// ----------------------------------------------------------------------------------
...
class cltbl_Ambiente_ImagenApp_v2_0_0
{
	 ...
	 // Base de datos
	 private  String NombreDeLaTabla = "tbl_ambiente_imagenapp";
     private  String NombreDeLaVista = "tbl_ambiente_imagenapp_view";
     private  String NombreCampoLlave ="nIDImagenApp";
	 private  String NombreCampoOrdenamiento="nIDImagenApp";
