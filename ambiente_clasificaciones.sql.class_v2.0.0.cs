// ----------------------------------------------------------------------------------
// ambiente_clasificaciones.sql.class_2.0.0.cs
// ----------------------------------------------------------------------------------
...
namespace Ambiente_Clasificaciones
{

class cltbl_Ambiente_Clasificaciones_v2_0_0
{
	 ...
	 // Base de datos
	 private  String NombreDeLaTabla = "tbl_ambiente_clasificaciones";
     private  String NombreDeLaVista = "tbl_ambiente_clasificaciones_view";
     private  String NombreCampoLlave ="nIDAmbiente_Clasificacion";
	 private  String NombreCampoOrdenamiento="Clasificacion";
	 private  String NombreCampoParaNoRepetir="Clasificacion";
