// ----------------------------------------------------------------------------------
// cat_pasillos.sql.class_2.0.0.cs
// ----------------------------------------------------------------------------------
...
namespace Cat_Pasillos
{

class cltbl_Cat_Pasillos_v2_0_0
{
	 ...
	 // Base de datos
	 private  String NombreDeLaTabla = "tbl_cat_pasillos";
     private  String NombreDeLaVista = "tbl_cat_pasillos";
     private  String NombreCampoLlave ="nIDCat_Pasillo";
	 private  String NombreCampoOrdenamiento="Pasillo";
	 private  String NombreCampoParaNoRepetir="IDPasillo";
