...
namespace Cat_Matriz
{

class cltbl_Cat_Matriz_v2_0_0
{
	 ...
	 // Base de datos
	 private  String NombreDeLaTabla = "tbl_cat_matriz";
     private  String NombreDeLaVista = "tbl_cat_matriz_view";
     private  String NombreCampoLlave ="nIDCat_Matriz";
	 private  String NombreCampoOrdenamiento="RazonSocial, Almacen, Pasillo, Rack, Nivel, SubNivel, Columna";
	 private  String NombreCampoParaNoRepetir="IDMatriz";
