// ----------------------------------------------------------------------------------
// ambiente_logo.sql.class_2.0.0.cs
// ----------------------------------------------------------------------------------
...
namespace Ambiente_Logo
{

class cltbl_Ambiente_Logo_v2_0_0
{
	 ...
	 // Base de datos
	 private  String NombreDeLaTabla = "tbl_ambiente_logo";
     private  String NombreDeLaVista = "tbl_ambiente_logo_view";
     private  String NombreCampoLlave ="nIDLogo";
	 private  String NombreCampoOrdenamiento="nIDLogo";
	 private  String NombreCampoParaNoRepetir="Logo";
