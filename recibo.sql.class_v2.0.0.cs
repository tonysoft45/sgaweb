...
class cltbl_Recibo_v2_0_0
{
	 ...
	 // Base de datos
	 private  String NombreDeLaTabla = "tbl_recibo";
     private  String NombreDeLaVista = "tbl_recibo_view";
     private  String NombreCampoLlave ="nIDRecibo";
