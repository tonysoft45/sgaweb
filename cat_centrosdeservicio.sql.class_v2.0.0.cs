// ----------------------------------------------------------------------------------
// cat_centrosdeservicio.sql.class_2.0.0.cs
// ----------------------------------------------------------------------------------
...
namespace Cat_CentrosDeServicio
{

class cltbl_Cat_CentrosDeServicios_v2_0_0
{
	 ...
	 // Base de datos
	 private  String NombreDeLaTabla = "tbl_cat_centrosdeservicio";
     private  String NombreDeLaVista = "tbl_cat_centrosdeservicio";
     private  String NombreCampoLlave ="nIDCat_CentroDeServicio";
	 private  String NombreCampoOrdenamiento="CentroDeServicio";
	 private  String NombreCampoParaNoRepetir="IDCentroDeServicio";
