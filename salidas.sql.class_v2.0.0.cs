...
class cltbl_Salidas_v2_0_0
{
	 ...
	 // Base de datos
	 private  String NombreDeLaTabla = "tbl_salidas";
     private  String NombreDeLaVista = "tbl_salidas_view";
     private  String NombreCampoLlave ="nIDSalida";
