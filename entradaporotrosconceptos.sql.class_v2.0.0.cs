// ----------------------------------------------------------------------------------
// entradaporotrosconceptos.sql.class_2.0.0.cs
// ----------------------------------------------------------------------------------
...
namespace EntradaPorOtrosConceptos
{
...
class cltbl_EntradaPorOtrosConceptos_Deta_v2_0_0
{
	 ...
	 // Base de datos
	 private  String NombreDeLaTabla = "tbl_entradaporotrosconceptos";
     private  String NombreDeLaVista = "tbl_entradaporotrosconceptos_view";
     private  String NombreCampoLlave ="nIDEntradaPorOtrosConceptos";
