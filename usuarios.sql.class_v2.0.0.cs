...
class cltbl_Usuarios_v2_0_0
{
	 ...
	 // Base de datos
	 private  String NombreDeLaTabla = "tbl_usuarios";
     private  String NombreDeLaVista = "tbl_usuarios_view";
     private  String NombreCampoLlave ="nIDUsuario";
	 private  String NombreCampoOrdenamiento="Nombre";
	 private  String NombreCampoParaNoRepetir="Usuario";
	 ...
	 public void Cargar_Campos_Obligatorios(){	 
		...
		this.campos_obligatorios.add("Usuario");		 	
		this.campos_obligatorios.add("Nombre");		 
		this.campos_obligatorios.add("nIDPerfil");		 	 		 
		...
		this.campos_obligatorios_leyendas.add("Usuario"); 
		this.campos_obligatorios_leyendas.add("Nombre del Usuario");	
		this.campos_obligatorios_leyendas.add("Perfil");	
	 ...
	 public void Cargar_Campos_Listado(){	 
		...
		this.campos_listado.add("Usuario");
		this.campos_listado.add("Nombre");	
	 ...
	 public void Cargar_Campos_Busqueda(){	 
		 ...
		 this .campos_busqueda,"Usuario");
		 this .campos_busqueda,"Clave");	
		 this .campos_busqueda,"Nombre");	
		 this .campos_busqueda,"Direccion");	
		 this .campos_busqueda,"Telefono");	
		 this .campos_busqueda,"Celular");	
		 this .campos_busqueda,"Email");		
